...
if (!is_dir($projectPath)) { http_response_code(500); exit("Path not found"); }
chdir($projectPath);
if (!file_exists($projectPath . '/vendor/autoload.php')) { http_response_code(500); exit("vendor/autoload.php not found"); }
